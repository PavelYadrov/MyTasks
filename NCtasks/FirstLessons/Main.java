...
import com.task1.pavelyadrov.Circle;
import com.task2.pavelyadrov.Rectangle;
import com.task3.pavelyadrov.Employee;
import com.task4.pavelyadrov.Author;
import com.task4.pavelyadrov.Book;
import com.task5.pavelyadrov.MyPoint;
import com.task6.pavelyadrov.MyTriangle;
import com.task7.pavelyadrov.MyComplex;
import com.task8.pavelyadrov.MyPolynomial;
import com.task9.pavelyadrov.Ball;
import com.task9.pavelyadrov.Container;
...
public class Main {
    public static void main(String[] args) {
        ...
        //control check for the Book class
            ...
            Book book2 = new Book("Odyssey",new Author[]{new Author("someone"),new Author("Homer")},1313,32);
        ...
        //control check for the MyTriangle class
            ...
            MyTriangle myTriangle1 = new MyTriangle(0,0,2,0,1,1);
            MyTriangle myTriangle2 = new MyTriangle(2,1,4,1,3,2);
            System.out.println(myTriangle1);
            System.out.println(myTriangle1.getPerimeter());
            System.out.println(myTriangle1.getType());
            System.out.println(myTriangle1.equals(myTriangle2));
